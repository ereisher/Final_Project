...
2. Pre-process the data using FastQC and MultiQC- files can be found in the [Pre-Process folder]([https://github.com/clayton-lab/BugSeq-er](https://github.com/ereisher/Final_Project/tree/main/Pre-Process)
